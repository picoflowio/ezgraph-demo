...
export class PresentationDecisionNode extends DecisionNode<DecisionHotelGraphStateType, typeof PRESENTATION_QUESTIONS> {
  defineQuestions() { return PRESENTATION_QUESTIONS; }
  getPrompt(): string { return hotelPrompts.presentationJudge; }
