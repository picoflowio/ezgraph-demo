...
export type DecisionHotelGraphNodes = {
  ...
  DateRangeNode?: NodeStateValue<{
    answered?: boolean;
    start?: string | null;
    end?: string | null;
  }>;
  BudgetNode?: NodeStateValue<{
    answered?: boolean;
    min?: number | null;
    max?: number | null;
  }>;
  RoomTypeNode?: NodeStateValue<{
    answered?: boolean;
    roomType?: "one bed" | "two beds" | "suite" | null;
  }>;
  AmenityNode?: NodeStateValue<{ answered?: boolean; amenities?: string[] }>;
  DistanceNode?: NodeStateValue<{
    answered?: boolean;
    airport?: number | null;
    cityCenter?: number | null;
  }>;
  CriteriaReadinessDecisionNode?: NodeStateValue<{
    review?: object;
    accepted?: boolean;
  }>;
  ...
  PresentationDecisionNode?: NodeStateValue<{
    review?: object;
    accepted?: boolean;
  }>;
};
